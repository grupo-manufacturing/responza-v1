...
export function LandingLogo({ variant = 'dark' }: { readonly variant?: 'light' | 'dark' }) {
  ...
  return (
    <Link to="/" className={`inline-flex items-center gap-2.5 ${textClass}`}>
      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-accent-soft via-accent to-accent-violet shadow-[0_4px_14px_rgb(91_138_133/0.35)]">
